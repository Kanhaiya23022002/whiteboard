...
paintWindow = np.zeros((650,800,3)) + 255
...
cv2.namedWindow('Custom_Canvas', cv2.WINDOW_AUTOSIZE)


# initializing mediapipe
mpHands = mp.solutions.hands
hands = mpHands.Hands(max_num_hands=1, min_detection_confidence=0.6)
# I am using this for marking the landmarks detected by the hand (haath mai landmarks knuckels honge)
